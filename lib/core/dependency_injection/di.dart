...
Future<void> init() async {
  ...
  di.registerLazySingleton(() => CheckRegisteredEmailUseCase(registerRepo: di()));
  ...
  di.registerLazySingleton<CheckRegisteredEmailService>(() => CheckRegisteredEmailServiceImpl());
