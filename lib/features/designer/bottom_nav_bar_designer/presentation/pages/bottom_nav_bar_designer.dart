...
import '../../../main/home/domain/entities/designer_stats_entity.dart';
import '../../../main/home/presentation/manager/designer_carousel_cubit.dart';
import '../../../main/home/presentation/manager/stats_cubit/stats_cubit.dart';
  ...
  final List<Widget> _body = [
    MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) => di.di<StatsCubit>()
            ..getStats(
              DesignerStatsEntity(
                userId: UserData.id,
              ),
