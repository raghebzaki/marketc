...
class DesignerSettingsView extends StatefulWidget {
  const DesignerSettingsView({super.key});

  @override
  State<DesignerSettingsView> createState() => _DesignerSettingsViewState();
}

class _DesignerSettingsViewState extends State<DesignerSettingsView> {
  @override
